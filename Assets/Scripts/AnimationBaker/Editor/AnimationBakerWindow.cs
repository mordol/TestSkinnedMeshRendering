...
namespace AnimationBaker.Editor
{
    public class AnimationBakerWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            GUILayout.Label("Bake Animation", EditorStyles.boldLabel);
            if (GUILayout.Button("Bake"))
            {
                Debug.Log("Baking animation...");
            }
        }
        ...
        private BakedAnimation BakeAnimation(SkinnedMeshRenderer skinnedMeshRenderer, AnimationClip[] animationClips)
        {
